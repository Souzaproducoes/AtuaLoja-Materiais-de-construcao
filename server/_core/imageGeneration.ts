...
// Default model for generated sites. "MODEL_GPT_IMAGE_2" is the external service images.v1
// enum for GPT Image 2 (id: gpt-image-2). If omitted, external service falls back to Gemini 2.5 Flash.
...
export type GenerateImageOptions = {
  ...
  /** external service image model enum, e.g. "MODEL_GPT_IMAGE_2". Defaults to GPT Image 2. */
  model?: string;
...
export type ImageModelInfo = {
  /** external service model enum, e.g. "MODEL_GPT_IMAGE_2". Pass into generateImage({ model }). */
  model?: string;
